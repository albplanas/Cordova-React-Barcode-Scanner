...
var ProjectsName=this.props.ShowReport[0].idproject.map(idpoyect=>{
  return  <li>{this.props.Project.filter(e=>e.id+""===idpoyect+"")[0].name}</li>
})
  ...
  const mapStateToProps = state => {
    return {
      ShowReport: state.localState.ShowReport,
      idLaborList:state.list.IdLabor,
      idEmloyeeList:state.list.IdEmployee,
      Project:state.list.Project,
